...
using CardStorageService.Services.CardStorageService.Services;
...
namespace CardStorageService
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IValidator<CreateCardRequest>, CreateCardRequetValidator>();
            ...
            var mapperConfigurationCard = new MapperConfiguration(mp => mp.AddProfile(new MappingsProfile()));
            var mapper = mapperConfigurationCard.CreateMapper();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Test service", Version = "v1.0.0.0" });
